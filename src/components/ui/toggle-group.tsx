...
function ToggleGroup({
  ...
  return (
    <ToggleGroupPrimitive
      ...
      className={cn(
        'group/toggle-group flex w-fit flex-row items-center gap-2 data-[spacing=0]:data-[variant=outline]:rounded-4xl data-vertical:flex-col data-vertical:items-stretch',
        spacing === 0 && 'gap-0',
        spacing === 1 && 'gap-1',
        className,
      )}
