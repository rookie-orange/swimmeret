  ...
  return (
    ...
    >
      <CheckboxPrimitive.Indicator
        ...
        className="grid place-content-center text-current transition-none [&>svg]:size-3.5 [&>svg:last-child]:hidden data-indeterminate:[&>svg:first-child]:hidden data-indeterminate:[&>svg:last-child]:block"
      >
